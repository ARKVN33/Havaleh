...
{
    /// <summary>
    /// Interaction logic for WinFactory.xaml
    /// </summary>
    public partial class WinFactory
    {
        private List<tblFactory> _factoryData;
        private List<tblFactory> _factorySearchData;
        ...
        public WinFactory()
        {
            ...
            _factorySearchData = new List<tblFactory>();
        }
        ...
        private async void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            _factorySearchData = _factoryData;
            if (string.IsNullOrEmpty(TxtSearch.Text.Trim()) || _add)
            {
                DgdData.ItemsSource = _factorySearchData;
        ...
        private async void BtnAdd_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                var addFactory = new DFactory
                {
                    DFactoryName = TxtName.Text.Trim() == string.Empty ? null : TxtName.Text
                };
        ...
        private async void TxtSearch_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            _factorySearchData = _factoryData;
            _factorySearchData =
                await Task.Run(() => _factorySearchData.FindAll(
                    t =>!string.IsNullOrEmpty(t.FactoryName) && t.FactoryName.Contains(search)));
        ...
        private void DgdDoctor_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            var selectItem = _factorySearchData[DgdData.SelectedIndex];
            TxtName.Text = selectItem.FactoryName;
        }
        ...
        private async void BtnDelete_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                var deleteFactory = new DFactory
                {
                    DId = selectItem.Id
                };
